...
| M2 能看懂 | FR-5 / FR-6（环形图、treemap、明细、筛选联动） | 组合视图正确、筛选联动一致 | 1.5–2 天 | 🔜 下一步 |
| M3 能长期用 | FR-7 / FR-8 + 空状态 + 响应式 + 陈旧提示 | 导出导入闭环、切换币种正确 | 1.5–2 天 | 待做 |
| 合计 | | | **约 8–10 人天** | 已完成约 5 天当量 |
